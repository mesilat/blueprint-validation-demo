...
@Named
public class CompanyEventListener extends BaseEventListener implements InitializingBean, DisposableBean {
    public static final String TEMPLATE_KEY = "com.mesilat.blueprint-validation-demo:bvp-company-template";
    public static final String ENDPOINT = "/rest/confield-demo/1.0/company";

    @Inject
    public CompanyEventListener(
